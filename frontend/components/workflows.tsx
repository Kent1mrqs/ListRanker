              ...
              <span
                ...
                Tailored Workflows
                    ...
                    <Spotlight className="group mx-auto grid max-w-sm items-start gap-6 lg:max-w-none lg:grid-cols-4">
                        <TemplateCard title='Built-in Tools' image={WorflowImg01} description={description1}/>
                        <TemplateCard title='Scale Instantly' image={WorflowImg02} description={description2}/>
                        <TemplateCard title='Tailored Flows' image={WorflowImg03} description={description3}/>
                        <TemplateCard title='Tailored Flows' image={WorflowImg03} description={description3}/>
                    </Spotlight>
                </div>
            </div>
